...
class Solution {
    public long flowerGame(int n, int m) {
        long oddFlowerCountInFirstRow = n / 2;
        long evenFlowerCountInFirstRow = n - oddFlowerCountInFirstRow;
        long oddFlowerCountInSecondRow = m / 2;
        long evenFlowerCountInSecondRow = m - m / 2;
        long res = oddFlowerCountInFirstRow * evenFlowerCountInSecondRow;
        res += evenFlowerCountInFirstRow * oddFlowerCountInSecondRow;
        return res;
    }
}
```